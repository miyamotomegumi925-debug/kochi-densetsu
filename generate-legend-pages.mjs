...
<section aria-labelledby="next-title"><h2 id="next-title">同じエリアの伝説</h2><div class="related-links">${relatedHtml}<a href="../../index.html#zukan">伝説図鑑へ戻る</a><a href="../../index.html">トップページへ戻る</a></div></section></article></main><footer class="article-footer">© 2026 LEGENDS OF KOCHI</footer><script src="../../src/legend-page.js?v=20260815-2" defer></script></body></html>`;
}
