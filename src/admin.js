import { dbSelect, dbInsert, dbUpdate, dbDelete, signInAdmin, refreshAdminSession, uploadLegendImage } from './supabase.js?v=20260731-1';
...
$('#legend-form').onsubmit = async event => {
  ...
  try {
    ...
    $('#legend-status').textContent = '✓ 登録しました。フォームをクリアしました。';
    await loadDashboard();
  }
